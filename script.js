...
MR.prototype.draw = function () {
    ...
    if (this.happyTime > 0) {
	this.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/score-"+direction+".png";
	this.happyTime--;
	if (this.happyTime <= 0) {
	    this.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/stand-"+direction+".png";
	}
    } else if (this.sadTime > 0) {
	this.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/punish-"+direction+".png";
	this.sadTime--;
	if (this.sadTime <= 0) {
	    this.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/stand-"+direction+".png";
	}
...
function Game(canvas, ctx) {
    ...
    this.init = function() {
	this.mrx = new MR(this.startX, this.startY, 'https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/stand-left.png');
	this.seeds = new Array;

	this.playerScore = 0;
	this.score = new Audio("https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/sounds/score.mp3");
	this.score.volume = .25;
	this.score.load();

	this.punish = new Audio("https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/sounds/punish.mp3");
	this.punish.volume = .25;
	this.punish.load();

	this.backgroundAudio = new Audio("https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/sounds/forest-night.mp3");
	...
	this.BG = new Image();
	this.BG.src = 'https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/Background.png';
    }
...
function run() {
	...
	case 37: { // Left Arrow
	    ...
	    game.mrx.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/run-left.png";
	...
	case 39: { // Right Arrow
	    ...
	    game.mrx.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/run-right.png";
	...
	switch(e.keyCode) {
	case 37: { // Left Arrow
	    game.mrx.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/stand-left.png";
	    break;
	}
	case 38: { // Up Arrow
	    break;
	...
	case 39: { // Right Arrow					
	    game.mrx.img.src = "https://raw.githubusercontent.com/EricZhou0815/JavaScript-game-catch-the-flower/master/img/stand-right.png";
	    break;
	}
	case 40: { // Down Arrow						
	    break;
